...
urlpatterns = [
    ...
    path("teachers/<int:id>/", SpecificTeacherListView.as_view(), name='specific_teachers'),
    path("parents/<int:id>/", SpecificParentListView.as_view(), name='specific_parents'),
    path("students/<int:id>/", SpecificStudentListView.as_view(), name='specific_students'),
